...
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY, Color colorBody, Color colorEye, Color colorMouth)
	{
		...
		g2.drawString("Meowwwwwww", catX, catY+HEAD_DIMENSION+10);	
	}
}
